...
function inicializarHistoricoEPainel() {
    ...
    container.innerHTML = `
      <li class="empty-state">
        <div class="empty-content">
          ...
          <p>Ainda não há registros no seu histórico. Cadastre os hábitos do seu primeiro dia na aba <strong>Dashboard / Cadastro</strong> para acender a sua chama da ofensiva!</p>
        </div>
      </li>
    `;
    return;
